...
<body>
  ...
  <div class="content">
    <h1>cyber_absolutus</h1>
    <p><strong>Author:</strong> zqwy</p>
    <img class="cover" src="https://dn720704.ca.archive.org/0/items/cyber_absolutus/zqwy_limon_cover.webp" alt="zqwy_cyber_absolutus" />
    <section>
      <h2>Описание</h2>
      <p></p>
    </section>
    ...
    <iframe name="player" class="player" src="https://archive.org/details/cyber_absolutus" scrolling="no" title="zqwy_cyber_absolutus"></iframe>
  </div>
</body>

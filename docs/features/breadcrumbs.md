...
You can also adjust where the breadcrumbs will be displayed by adjusting the [[deploy/to-east.github.io/docs/layout]] (moving `Component.Breadcrumbs()` up or down)

...
<body>
  ...
  <div class="content">
    <h1>drill_to_the_neighbor</h1>
    <p><strong>Author:</strong> zqwy</p>
    <img class="cover" src="" alt="zqwy_drill_to_the_neighbor" />
    <section>
      <h2>Описание</h2>
      <p></p>
    </section>
    ...
    <iframe name="player" class="player" src="" scrolling="no" title="zqwy_drill_to_the_neighbor"></iframe>
  </div>
</body>

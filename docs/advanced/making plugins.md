...
- `BuildCtx` is defined in `quartz/ctx.ts`. It consists of
  - `argv`: The command line arguments passed to the Quartz [[deploy/to-east.github.io/docs/build]] command
  - `cfg`: The full Quartz [[deploy/to-east.github.io/docs/configuration]]
  - `allSlugs`: a list of all the valid content slugs (see [[deploy/to-east.github.io/docs/advanced/paths]] for more information on what a slug is)
...
A good example of a transformer plugin that borrows from the `remark` and `rehype` ecosystems is the [[deploy/to-east.github.io/docs/plugins/Latex|Latex]] plugin:
...
- Your component should use `getQuartzComponents` to declare a list of `QuartzComponents` that it uses to construct the page. See the page on [[deploy/to-east.github.io/docs/advanced/creating components]] for more information.

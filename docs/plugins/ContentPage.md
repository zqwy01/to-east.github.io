...
This plugin is a core component of the Quartz framework. It generates the HTML pages for each piece of Markdown content. It emits the full-page [[deploy/to-east.github.io/docs/layout]], including headers, footers, and body content, among others.

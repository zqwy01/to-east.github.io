...
This plugin generates index pages for folders, creating a listing page for each folder that contains multiple content files. See [[deploy/to-east.github.io/docs/features/folder and tag listings]] for more information.

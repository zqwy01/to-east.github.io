...
By default, it shows all folders and files on your page. To display the explorer in a different spot, you can edit the [[deploy/to-east.github.io/docs/layout]].

Display names for folders get determined by the `title` frontmatter field in `folder/index.md` (more detail in [[deploy/to-east.github.io/docs/authoring content| Authoring Content]]). If this file does not exist or does not contain frontmatter, the local folder name will be used instead.
...
- Removing explorer: remove `Component.Explorer()` from `quartz.layout.ts`
  - (optional): After removing the explorer component, you can move the [[deploy/to-east.github.io/docs/features/table of contents| Table of Contents]] component back to the `left` part of the layout

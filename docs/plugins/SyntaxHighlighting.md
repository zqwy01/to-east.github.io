...
This plugin is used to add syntax highlighting to code blocks in Quartz. See [[deploy/to-east.github.io/docs/features/syntax highlighting]] for more information.

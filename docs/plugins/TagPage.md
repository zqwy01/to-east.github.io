...
This plugin emits dedicated pages for each tag used in the content. See [[deploy/to-east.github.io/docs/features/folder and tag listings]] for more information.

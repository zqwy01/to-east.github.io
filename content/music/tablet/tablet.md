...
<body>
  ...
  <div class="content">
    ...
    <img class="cover" src="" alt="zqwy_tablet" />
    <section>
      <h2>Описание</h2>
      <p>Акс впервые встречает скрижаль так близко, что становится заложником в вечном лабиринте. </p>
    </section>
    <section>
      <h2>Инструменты</h2>
      <p></p>
    </section>
    <iframe name="player" class="player" src="" scrolling="no" title="zqwy_tablet"></iframe>

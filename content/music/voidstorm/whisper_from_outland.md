...
<body>
  ...
  <div class="content">
    <h1>whisper_from_outland</h1>
    <p><strong>Author:</strong> zqwy</p>
    <img class="cover" src="https://i.pinimg.com/474x/5d/a6/a4/5da6a46cf3001323588b55d097de56ea.jpg" alt="zqwy_whisper_from_outland" />
    <section>
      <h2>Описание</h2>
      <p></p>
    </section>
    ...
    <iframe name="player" class="player" src="" scrolling="no" title="zqwy_whisper_from_outland"></iframe>
  </div>
</body>

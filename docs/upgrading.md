...
> [!note]
> This is specifically a guide for upgrading Quartz 4 version to a more recent update. If you are coming from Quartz 3, check out the [[deploy/to-east.github.io/docs/migrating from Quartz 3|migration guide]] for more info.

...
This functionality is provided by the [[deploy/to-east.github.io/docs/plugins/OxHugoFlavoredMarkdown]] plugin. See the plugin page for customization options.

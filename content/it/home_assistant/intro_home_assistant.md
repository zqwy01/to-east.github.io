...
## Home Assistant — центр для: [интеграции](https://www.home-assistant.io/integrations/), [управление IoT, автоматизации, дэшбордов, голосовых помощников, организация объектов, контроль электричества, аутентификация и как итог операционная система - сервер - клиент](https://www.home-assistant.io/docs/)
